...
class Shrec(SceneFlowDataset):
    ...
    def make_dataset(self):
        ...
        test_list =[i for i in range(1960,2800)] #  #test_list对应序号1960-2799
        # 上改8：test_list:后840条（1960-2799）
        ...
        train_list=[i for i in range(1960)]   #train_list对应序号1-1959
        ...
        if self.mode == "train":
            ...
            assert len(filenames_test) == 840, "Problem with size of kitti test dataset"
            ...
            assert len(filenames_all) == 2800, "Problem with size of kitti dataset"
