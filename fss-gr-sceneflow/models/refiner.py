...
class Refiner(torch.nn.Module):
    ...
    def refine_flow(self, batch, flow, corr_conf, optimizer, args):
        ...
        #原来：graph = Graph.construct_graph_in_chunks(pc_0_orig, 32, 2048)  32:是nb_neighbors（每个点考虑的邻居数，2048是chunck size,在那个scripts/evaluate_on_shrec.sh中nb_points=2048,代码中nb_points就是PC1点数）
        #修改
        graph = Graph.construct_graph_in_chunks(pc_0_orig, 12, 16)#可以变12，但要小于nb_points=16
        #修改
        # results aggregation
